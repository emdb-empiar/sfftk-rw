...
# -*- coding: utf-8 -*-
#
# sfftkrw documentation build configuration file, created by
...
from sfftkrw.conf import SFFTKRW_VERSION
...
version = _str('.'.join(SFFTKRW_VERSION.split('.')[:2]))
# The full version, including alpha/beta/rc tags.
release = _str(SFFTKRW_VERSION)
