...
class Configs(_dict):
    ...
    """
    shipped_configs = os.path.join(BASE_DIR, 'sffrw.conf')
...
def get_config_file_path(args, user_folder='~/.sfftkrw', user_conf_fn='sffrw.conf', config_class=Configs):
    ...
    .. code:: bash
        ...
        sff notes list --config-path /path/to/sffrw.conf file.json
    ...
    .. code:: bash
        ...
        sff config get --config-path /path/to/sffrw.conf --all
        # ignore shipped still!
        sff config get --config-path /path/to/sffrw.conf --shipped-configs --all
    ...
    .. code:: bash
        ...
        sff config set --config-path /path/to/sffrw.conf NAME VALUE
