#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Unit tests for :py:mod:`sfftkrw.core.notes` package"""
...
from ..sffrw import _handle_notes_modify, handle_notes_trash
...
# :TODO: rewrite to use sfftkrw.notes.modify.SimpleNote


class TestNotesModifyExternalReference(Py23FixTestCase):
    def test_ols(self):
        """Test that sfftkrw.notes.modify.ExternalReference object works correctly"""
        type_ = u'ncit'
